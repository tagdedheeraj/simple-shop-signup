...
const CallToAction: React.FC = () => {
  const handleContactClick = () => {
    window.location.href = 'mailto:hello@lakshmikrupaagriculture.com?subject=Inquiry about Processing Facilities';
  };
    ...
    >
      ...
      <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
        <Button 
          ...
          className="bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white px-6 md:px-8 py-3 md:py-4 text-base md:text-lg font-bold rounded-full shadow-xl border-2 border-white/20 w-full sm:w-auto"
        >
          Contact Now
        </Button>
      </motion.div>
